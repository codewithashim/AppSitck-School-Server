...
router.get("/:id", homeslider_controller_1.HomeSliderController.getHomeSliderById);
router.post("/create", homeslider_controller_1.HomeSliderController.createHomeSlider);
router.patch("/:id", homeslider_controller_1.HomeSliderController.updateHomeSlider);
router.delete("/:id", homeslider_controller_1.HomeSliderController.deleteHomeSlider);
