...
router.get("/get-singel/:id", committee_controller_1.CommitteeController.getCommitteeById);
router.post("/create", committee_controller_1.CommitteeController.createCommittee);
router.patch("/update/:id", committee_controller_1.CommitteeController.updateCommittee);
router.delete("/delete/:id", committee_controller_1.CommitteeController.deleteCommittee);
