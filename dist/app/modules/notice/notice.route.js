...
router.get("/get-singel/:id", notice_controller_1.NoticeController.getNoticeById);
router.patch("/update/:id", multer_1.default.single("file"), notice_controller_1.NoticeController.updateNotice);
router.delete("/delete/:id", notice_controller_1.NoticeController.deleteNotice);
