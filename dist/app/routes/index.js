...
const rutine_route_1 = require("../modules/rutine/rutine.route");
const sylebus_route_1 = require("../modules/sylebus/sylebus.route");
const studentPortal_route_1 = require("../modules/studentPortal/studentPortal.route");
...
const moduleRoutes = [
    ...
    {
        path: "rutine",
        route: rutine_route_1.RutineRoutes,
    },
    {
        path: "sylebus",
        route: sylebus_route_1.SylebusRoutes,
    },
    {
        path: "student-portal",
        route: studentPortal_route_1.StudentPortalRoutes,
    },
];
